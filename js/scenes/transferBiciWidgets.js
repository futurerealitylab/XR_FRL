...
// fixed virtual screen (no calibration, no save file — the layout is embedded).
//
...
export const init = async model => {
   ...
   const PANE_TILT   = 0;                            // 0 = upright/vertical screen (negative tilts it back)
   ...
   // Unit-scaled world frame at the card's center on the pane (so content keeps
   // its proportions). Refreshes the card's half-size in meters. FACE_SIGN flips
